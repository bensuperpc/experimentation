...
template<class T>
static void vectorXor(benchmark::State& state)
{
...
BENCHMARK(vectorXor<uint8_t>)
    ->Name("vectorXor<uint8_t>")
    ...
    ->UseRealTime()
    ->Repetitions(1);
BENCHMARK(vectorXor<uint_fast8_t>)
    ->Name("vectorXor<uint_fast8_t>")
    ->RangeMultiplier(multiplier) 
    ->Range(minRange, maxRange) 
    ->ThreadRange(minThreadRange, maxThreadRange) 
    ->Unit(benchmark::kNanosecond)
    ...
    ->UseRealTime()
    ->Repetitions(1);
BENCHMARK(vectorXor<uint16_t>)
    ->Name("vectorXor<uint16_t>")
    ->RangeMultiplier(multiplier) 
    ->Range(minRange, maxRange) 
    ->ThreadRange(minThreadRange, maxThreadRange)
    ->Unit(benchmark::kNanosecond)
    ...
    ->UseRealTime()
    ->Repetitions(1);
BENCHMARK(vectorXor<uint_fast16_t>)
    ->Name("vectorXor<uint_fast16_t>")
    ->RangeMultiplier(multiplier) 
    ->Range(minRange, maxRange) 
    ->ThreadRange(minThreadRange, maxThreadRange) 
    ->Unit(benchmark::kNanosecond)
    ...
    ->UseRealTime()
    ->Repetitions(1);
BENCHMARK(vectorXor<uint32_t>)
    ->Name("vectorXor<uint32_t>")
    ->RangeMultiplier(multiplier) 
    ->Range(minRange, maxRange) 
    ->ThreadRange(minThreadRange, maxThreadRange)
    ->Unit(benchmark::kNanosecond)
    ...
    ->UseRealTime()
    ->Repetitions(1);
BENCHMARK(vectorXor<uint_fast32_t>)
    ->Name("vectorXor<uint_fast32_t>")
    ->RangeMultiplier(multiplier)
    ->Range(minRange, maxRange)
    ->ThreadRange(minThreadRange, maxThreadRange)
    ->Unit(benchmark::kNanosecond)
    ...
    ->UseRealTime()
    ->Repetitions(1);
BENCHMARK(vectorXor<uint64_t>)
    ->Name("vectorXor<uint64_t>")
    ->RangeMultiplier(multiplier)
    ->Range(minRange, maxRange)
    ->ThreadRange(minThreadRange, maxThreadRange)
    ->Unit(benchmark::kNanosecond)
    ...
    ->UseRealTime()
    ->Repetitions(1);
BENCHMARK(vectorXor<uint_fast64_t>)
    ->Name("vectorXor<uint_fast64_t>")
    ->RangeMultiplier(multiplier)
    ->Range(minRange, maxRange)
    ->ThreadRange(minThreadRange, maxThreadRange)
    ->Unit(benchmark::kNanosecond)
