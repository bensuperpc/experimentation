...
auto main() -> int
{
  benlib::object::experimentation::Experimentation experimentation;
  ...
  list.emplace_back(std::make_pair(
      "function1",
      std::bind(&benlib::object::experimentation::Experimentation::function1, experimentation, std::placeholders::_1)));

  list.emplace_back(std::make_pair(
      "function2",
      std::bind(&benlib::object::experimentation::Experimentation::function2, experimentation, std::placeholders::_1)));

  list.emplace_back(std::make_pair(
      "function3",
      std::bind(&benlib::object::experimentation::Experimentation::function3, experimentation, std::placeholders::_1)));
