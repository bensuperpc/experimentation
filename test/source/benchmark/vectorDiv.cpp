...
BENCHMARK(vectorDiv<uint8_t>)
    ->Name("vectorDiv<uint8_t>")
    ...
    ->UseRealTime()
    ->Repetitions(1);
BENCHMARK(vectorDiv<uint_fast8_t>)
    ->Name("vectorDiv<uint_fast8_t>")
    ->RangeMultiplier(multiplier) 
    ->Range(minRange, maxRange) 
    ->ThreadRange(minThreadRange, maxThreadRange)
    ->Unit(benchmark::kNanosecond) 
    ...
    ->UseRealTime()
    ->Repetitions(1);
BENCHMARK(vectorDiv<uint16_t>)
    ->Name("vectorDiv<uint16_t>")
    ->RangeMultiplier(multiplier) 
    ->Range(minRange, maxRange) 
    ->ThreadRange(minThreadRange, maxThreadRange)
    ->Unit(benchmark::kNanosecond) 
    ...
    ->UseRealTime()
    ->Repetitions(1);
BENCHMARK(vectorDiv<uint_fast16_t>)
    ->Name("vectorDiv<uint_fast16_t>")
    ->RangeMultiplier(multiplier) 
    ->Range(minRange, maxRange) 
    ->ThreadRange(minThreadRange, maxThreadRange)
    ->Unit(benchmark::kNanosecond)
    ...
    ->UseRealTime()
    ->Repetitions(1);
BENCHMARK(vectorDiv<uint32_t>)
    ->Name("vectorDiv<uint32_t>")
    ->RangeMultiplier(multiplier)
    ->Range(minRange, maxRange)
    ->ThreadRange(minThreadRange, maxThreadRange)
    ->Unit(benchmark::kNanosecond) 
    ...
    ->UseRealTime()
    ->Repetitions(1);
BENCHMARK(vectorDiv<uint_fast32_t>)
    ->Name("vectorDiv<uint_fast32_t>")
    ->RangeMultiplier(multiplier)
    ->Range(minRange, maxRange)
    ->ThreadRange(minThreadRange, maxThreadRange)
    ->Unit(benchmark::kNanosecond) 
    ...
    ->UseRealTime()
    ->Repetitions(1);
BENCHMARK(vectorDiv<uint64_t>)
    ->Name("vectorDiv<uint64_t>")
    ->RangeMultiplier(multiplier)
    ->Range(minRange, maxRange)
    ->ThreadRange(minThreadRange, maxThreadRange)
    ->Unit(benchmark::kNanosecond) 
    ...
    ->UseRealTime()
    ->Repetitions(1);
BENCHMARK(vectorDiv<uint_fast64_t>)
    ->Name("vectorDiv<uint_fast64_t>")
    ->RangeMultiplier(multiplier)
    ->Range(minRange, maxRange)
    ->ThreadRange(minThreadRange, maxThreadRange)
    ->Unit(benchmark::kNanosecond) 
