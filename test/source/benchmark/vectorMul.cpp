...
BENCHMARK(vectorMul<uint8_t>)
    ->Name("vectorMul<uint8_t>")
    ...
    ->UseRealTime()
    ->Repetitions(1);
BENCHMARK(vectorMul<uint_fast8_t>)
    ->Name("vectorMul<uint_fast8_t>")
    ->RangeMultiplier(multiplier) 
    ->Range(minRange, maxRange) 
    ->ThreadRange(minThreadRange, maxThreadRange) 
    ->Unit(benchmark::kNanosecond) 
    ...
    ->UseRealTime()
    ->Repetitions(1);
BENCHMARK(vectorMul<uint16_t>)
    ->Name("vectorMul<uint16_t>")
    ->RangeMultiplier(multiplier) 
    ->Range(minRange, maxRange) 
    ->ThreadRange(minThreadRange, maxThreadRange) 
    ->Unit(benchmark::kNanosecond) 
    ...
    ->UseRealTime()
    ->Repetitions(1);
BENCHMARK(vectorMul<uint_fast16_t>)
    ->Name("vectorMul<uint_fast16_t>")
    ->RangeMultiplier(multiplier) 
    ->Range(minRange, maxRange) 
    ->ThreadRange(minThreadRange, maxThreadRange) 
    ->Unit(benchmark::kNanosecond) 
    ...
    ->UseRealTime()
    ->Repetitions(1);
BENCHMARK(vectorMul<uint32_t>)
    ->Name("vectorMul<uint32_t>")
    ->RangeMultiplier(multiplier) 
    ->Range(minRange, maxRange) 
    ->ThreadRange(minThreadRange, maxThreadRange) 
    ->Unit(benchmark::kNanosecond) 
    ...
    ->UseRealTime()
    ->Repetitions(1);
BENCHMARK(vectorMul<uint_fast32_t>)
    ->Name("vectorMul<uint_fast32_t>")
    ->RangeMultiplier(multiplier) 
    ->Range(minRange, maxRange) 
    ->ThreadRange(minThreadRange, maxThreadRange) 
    ->Unit(benchmark::kNanosecond) 
    ...
    ->UseRealTime()
    ->Repetitions(1);
BENCHMARK(vectorMul<uint64_t>)
    ->Name("vectorMul<uint64_t>")
    ->RangeMultiplier(multiplier) 
    ->Range(minRange, maxRange) 
    ->ThreadRange(minThreadRange, maxThreadRange) 
    ->Unit(benchmark::kNanosecond) 
    ...
    ->UseRealTime()
    ->Repetitions(1);
BENCHMARK(vectorMul<uint_fast64_t>)
    ->Name("vectorMul<uint_fast64_t>")
    ->RangeMultiplier(multiplier) 
    ->Range(minRange, maxRange) 
    ->ThreadRange(minThreadRange, maxThreadRange)
    ->Unit(benchmark::kNanosecond) 
